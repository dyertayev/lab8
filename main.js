...
let sum4=lab4_5[0]+lab4_5[1]+lab4_5[2]+lab4_5[3]+lab4_5[4]+lab4_5[5]+lab4_5[6]+lab4_5[7]+lab4_5[8]+lab4_5[9]+lab4_5[10]
let sum6=lab6[0]+lab6[1]+lab6[2]+lab6[3]+lab6[4]+lab6[5]
let sums=[sum1,sum2,sum3,sum4,sum6,quiz1]
let total_score=(((sums[0]+sums[1]+sums[2]+sums[4])/160)+sums[3]/80)/2*60+(sums[5]/40)*40
const results = {
    ...
    sums: [sum1,sum2,sum3,sum4,sum6,quiz1], // array of sums of each lab
    total_score: (sums[0]+sums[1]+sums[2]+sums[3]+sums[4])/240*60+sums[5]*40/40 // computed total score
    }
console.log(results)